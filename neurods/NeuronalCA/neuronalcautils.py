...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 18 13:44:31 2024

@author: reinierramos
"""

import numpy as np
from .neuronalcaboundary import getNeighbors
...
def updateGrid(L:int, grid:list[float], grid_coords:list[int], propsCA:dict):
    """
    Updates the Neuronal CA by applying activation equation.
    ...
    for j,i in grid_coords:
        a_in = np.mean(getNeighbors(propsCA, prev, j, i))
        grid[j,i] = activationFunction(a_in, a0, a1, a2, nl)
    return grid
