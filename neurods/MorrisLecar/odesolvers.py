...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 18 21:19:44 2024
...
from .mlsteadystate import inf_n
from .mlsystem import (odes, Iext)
...
def lsoda(tList, kwargs):
    ...
    guess = np.array([Vrest, inf_n(Vrest)])
...
def euler(tList, kwargs):
    ...
    if 'coupled' in kwargs.get('system'):
        ...
        soln = np.zeros([population, len(tList), 2])
        soln[:,0,:] = guess
        guess = soln[:,0,:]
