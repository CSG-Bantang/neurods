...
# #%%% Nonlinear
# soln=NCA.solveNCA(al=2, neighborhood='Moore', init='beta', mu=0.9, nu=20)
# NCA.animateNCA(soln)

#%%% Nonlinear
# soln=NCA.solveNCA(lattice='spherical')
# NCA.animate3D(soln)

# soln = NCA.solveLayerNCA(L = 20, layers=2)
# # NCA.animateLNCA(soln)
# NCA.animate3DLNCA(soln)
