...
# figInputA1[1].set_title('Single HH constant input')
...
# figInputB[1].set_title('Noisy HH constant input')
...
# figInputC[1].set_title('Coupled HH constant input')

# #%%% Noisy Coupled HH with bias and sinusoid input
# soln, Ilist, t  = HH.solveHH(system='noisy coupled', solver='euler', I0=2.5, Is=10, fs=4.905, In=60, L=3, g=0.1)
...
# figInputD[1].set_title('Noisy Coupled HH bias and sinusoid input')
# plt.show()
# plt.close()
